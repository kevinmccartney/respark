...
The conceptual / oracle card (`oracle_id` from Scryfall). Shared rules text, colors, type line. Search and autocomplete query this table; the deck builder then picks a printing.
