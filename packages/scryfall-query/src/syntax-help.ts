/**
 * Respark-supported Scryfall syntax help (markdown).
 * Kept in sync with FIELD_ALIASES / unsupported lists in fields.ts.
 * Not a verbatim copy of Scryfall’s public docs.
 */
export const SYNTAX_HELP_MARKDOWN = `# Respark Scryfall syntax
